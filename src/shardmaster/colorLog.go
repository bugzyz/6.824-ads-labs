...
//print is the switch of the master rpc function outprint control
const print = -1
...
const (
	...
	info = "[INFO-shardMaster]"
	trac = "[TRAC-shardMaster]"
	erro = "[ERRO-shardMaster]"
	warn = "[WARN-shardMaster]"
	succ = "[SUCC-shardMaster]"
)
